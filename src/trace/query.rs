...
mod tests {
    ...
    fn record(args: RecordArgs) -> TraceRecord {
        TraceRecord {
            schema_version: CURRENT_SCHEMA_VERSION,
            record_id: format!("rec_{}_{}", args.name, args.ts_unix_ms),
            trace_id: args.run_id.to_string(),
            run_id: args.run_id.to_string(),
            span_id: args.span_id.map(str::to_string),
            parent_span_id: args.parent_span_id.map(str::to_string),
