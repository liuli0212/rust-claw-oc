...
pub struct SkillInvocation {
    ...
    pub call_chain_context: CallChainContext,
...
impl SkillInvocation {
    pub fn state_summary(&self) -> String {
        ...
        if let Some(handoff_context) = &self.handoff_context {
            parts.push(format!("Handoff context: {}", handoff_context));
        }
...
mod tests {
    ...
    fn test_state_summary_includes_raw_and_json_args() {
        let invocation = SkillInvocation {
            ...
            handoff_context: Some("Please focus on parsing.".to_string()),
            pending_interaction: None,
            state: SkillInvocationState::Running,
            call_chain_context: CallChainContext::new_root("root"),
        ...
        assert!(summary.contains("Handoff context: Please focus on parsing."));
    }
}
